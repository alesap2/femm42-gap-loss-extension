...
Las pérdidas de exceso son genuinamente pequeñas en este material amorfo, y el $k_e$ medido de $8 \times 10^{-7}$ W·s²/kg es el coeficiente eddy real del sistema. La discrepancia de 5.5× respecto a la fórmula de lámina delgada se debe muy probablemente al **acoplamiento inter-laminar**: con aislamiento imperfecto entre láminas (fisuras en el epoxy o en la capa de óxido formada durante el procesado térmico), los bucles de corriente de Foucault pueden cerrarse a través de varias láminas en paralelo, aumentando el $d_{\rm eff}$ respecto al espesor nominal de cada cinta. Esto es inherente al **método constructivo del núcleo amorfo enrollado**: la cinta se bobina sobre sí misma y el aislante interlaminado (epoxy, óxido propio) es delgado e imperfecto, especialmente en el interior del bobinado donde la presión de contacto es mayor.
...
Un $d_{\rm eff} \approx 67\,\mu$m sobre láminas de 23 µm equivale a grupos de ~3 láminas acopladas eléctricamente, lo cual es plausible dado el proceso de fabricación. Nótese que este análisis procede de las **curvas del fabricante** (cuya geometría de medida no se especifica en la hoja de datos), y no implica nada respecto al gap ni al tipo de corte del núcleo.

> **Consecuencia práctica:** el valor $k_e = 8 \times 10^{-7}$ W·s²/kg obtenido de las curvas del fabricante es el correcto para usar en predicciones con este material, puesto que refleja el comportamiento real del apilado laminado incluyendo el acoplamiento inter-laminar propio del proceso constructivo. No debe ser sustituido por el valor teórico de lámina delgada aislada. La separación 2T es suficiente y robusta para este dataset.
