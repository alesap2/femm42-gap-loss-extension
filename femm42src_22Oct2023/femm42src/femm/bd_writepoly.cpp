...
// to triangle from the CbeladrawDoc class
...
double CbeladrawDoc::LineLength(int i)
{
...
BOOL CbeladrawDoc::HasPeriodicBC()
{
	BOOL flag=FALSE;
	int i,j,k;
...
BOOL CbeladrawDoc::FunnyOnWritePoly() 
{
	FILE *fp;
