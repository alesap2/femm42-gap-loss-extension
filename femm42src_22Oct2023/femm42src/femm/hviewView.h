...
class ChviewView : public CView
{
protected: // create from serialization only
	ChviewView();
	DECLARE_DYNCREATE(ChviewView)

// Attributes
public:
	
	ChviewDoc* GetDocument();
...
public:
	...
	void PlotSelectedElm(CDC *pDC,hviewtype::CElement &elm);
	void RedrawView();
	void UnselectAll();
...
#ifndef _DEBUG  // debug version in hviewView.cpp
inline ChviewDoc* ChviewView::GetDocument()
